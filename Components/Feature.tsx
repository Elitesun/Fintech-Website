...
<div>
    ...
    <section className="container mx-auto px-4 py-20">
        ...
        <div className="grid grid-cols-4 gap-4 auto-rows-[180px]">
            <div
                className="col-span-2 row-span-2 bg-gradient-to-br from-purple-900/40 to-purple-800/40 p-8 rounded-3xl backdrop-blur-xl border border-purple-500/10 hover:border-purple-500/20 transition-all group">
                <Sparkles className="w-8 h-8 text-purple-400 mb-4 group-hover:text-purple-300 transition-colors" />
                <h3 className="text-2xl font-bold mb-4">Predictive Wealth Planning</h3>
            ...
            <div
                className="bg-gradient-to-br from-blue-900/40 to-blue-800/40 p-6 rounded-3xl backdrop-blur-xl border border-blue-500/10 hover:border-blue-500/20 transition-all group">
            ...
            <div
                className="bg-gradient-to-br from-emerald-900/40 to-emerald-800/40 p-6 rounded-3xl backdrop-blur-xl border border-emerald-500/10 hover:border-emerald-500/20 transition-all group">
            ...
            <div
                className="col-span-2 bg-gradient-to-br from-indigo-900/40 to-indigo-800/40 p-6 rounded-3xl backdrop-blur-xl border border-indigo-500/10 hover:border-indigo-500/20 transition-all group">
            ...
            <div
                className="bg-gradient-to-br from-rose-900/40 to-rose-800/40 p-6 rounded-3xl backdrop-blur-xl border border-rose-500/10 hover:border-rose-500/20 transition-all group">
            ...
            <div
                className="bg-gradient-to-br from-amber-900/40 to-amber-800/40 p-6 rounded-3xl backdrop-blur-xl border border-amber-500/10 hover:border-amber-500/20 transition-all group">
            ...
            <div
                className="col-span-2 bg-gradient-to-br from-cyan-900/40 to-cyan-800/40 p-6 rounded-3xl backdrop-blur-xl border border-cyan-500/10 hover:border-cyan-500/20 transition-all group">
